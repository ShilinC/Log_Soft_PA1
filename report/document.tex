...
\begin{figure}%
	...
	%\qquad
	%\subfloat[accuracy when lambda = 0.0001 using L2 regularization]{{\includegraphics[width=1.5in]{images/P8_6.png}  }}%
...
\begin{figure}%
	\centering
	\subfloat[weights when lambda = 0.1 using L1 regularization]{{\includegraphics[width=1.3in]{images/P10_7.png}  }}%
	\qquad	
	\subfloat[weights when lambda = 0.01 using L1 regularization]{{\includegraphics[width=1.3in]{images/P10.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.001 using L1 regularization]{{	\includegraphics[width=1.3in]{images/P10_2.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.0001 using L1 regularization]{{\includegraphics[width=1.3in]{images/P10_3.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.01 using L2 regularization]{{\includegraphics[width=1.3in]{images/P10_4.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.001 using L2 regularization]{{	\includegraphics[width=1.3in]{images/P10_5.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.0001 using L2 regularization]{{\includegraphics[width=1.3in]{images/P10_6.png}  }}%
