...
\begin{figure}%
	\centering
	\subfloat[accuracy when lambda = 0.01 using L1 regularization]{{\includegraphics[width=1.5in]{images/P7.png}  }}%
	\qquad
	\subfloat[accuracy when lambda = 0.001 using L1 regularization]{{	\includegraphics[width=1.5in]{images/P7_2.png}  }}%
	\qquad
	\subfloat[accuracy when lambda = 0.0001 using L1 regularization]{{\includegraphics[width=1.5in]{images/P7_3.png}  }}%
...
\begin{figure}%
	\centering
	\subfloat[accuracy when lambda = 0.01 using L2 regularization]{{\includegraphics[width=1.5in]{images/P8.png}  }}%
	\qquad
	\subfloat[accuracy when lambda = 0.001 using L2 regularization]{{	\includegraphics[width=1.5in]{images/P8_2.png}  }}%
	\qquad
	\subfloat[accuracy when lambda = 0.0001 using L2 regularization]{{\includegraphics[width=1.5in]{images/P8_3.png}  }}%
...
\begin{figure}%
	\centering
	\subfloat[weights when lambda = 0.01 using L1 regularization]{{\includegraphics[width=1.5in]{images/P10.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.001 using L1 regularization]{{	\includegraphics[width=1.5in]{images/P10_2.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.0001 using L1 regularization]{{\includegraphics[width=1.5in]{images/P10_3.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.01 using L2 regularization]{{\includegraphics[width=1.5in]{images/P10_4.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.001 using L2 regularization]{{	\includegraphics[width=1.5in]{images/P10_5.png}  }}%
	\qquad
	\subfloat[weights when lambda = 0.0001 using L2 regularization]{{\includegraphics[width=1.5in]{images/P10_6.png}  }}%
...
From Fig \ref{fig: 11} and Fig \ref{fig: 12} and we can see that the accuracy and loss function converges quickly and then becomes smooth. The plausible reason is that the learining rates in the first few epoches maybe a little large but after "annealing", the learning rates are suitable enough to make the algorithm converge. 
